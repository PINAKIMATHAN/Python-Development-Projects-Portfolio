...
label1 = tk.Label(window, background="#00008B", fg="#FFEBCD", text="Name :", width=10, height=1,
                  font=('Helvetica', 16))
label1.place(x=83, y=40)
std_name = tk.Entry(window, background="#7AC5CD", fg="black", width=25, font=('Helvetica', 14))
std_name.place(x=280, y=41)
label2 = tk.Label(window, background="#00008B", fg="#FFEBCD", text="Matric Number :", width=14, height=1,
                  font=('Helvetica', 16))
label2.place(x=100, y=90)
std_number = tk.Entry(window, background="#7AC5CD", fg="black", width=25, font=('Helvetica', 14))
...
label3 = tk.Label(window, background="#00008B", fg="red", text="Notification", width=10, height=1,
                  font=('Helvetica', 20, 'underline', 'bold'))
label3.place(x=320, y=155)
label4 = tk.Label(window, background="#7FFF00", fg="black", width=55, height=4, font=('Helvetica', 14, 'italic'))
...
trackImageBtn = tk.Button(window, command=trackImage, background="yellow", fg="black", text="TRACK IMAGE", width=12,
                          activebackground="red", height=3, font=('Helvetica', 12, 'bold'))
